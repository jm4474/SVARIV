...
nvar   =  1;  %Variable in which the shock will be imposed
...
[InferenceMSW.IRFSVARIV, InferenceMSW.dIRFdmu] = IRFSVARIV_2inst_j(RForm.AL,RForm.Sigma,RForm.Gamma,...
                      hori,x,nvar,@upperchol_id_minusj);
...
f     = @(AL,Sigma,Gamma,hori,x,nvar)...
        IRFSVARIV_2inst_j(AL,Sigma,Gamma,hori,x,nvar,@upperchol_id_minusj);
