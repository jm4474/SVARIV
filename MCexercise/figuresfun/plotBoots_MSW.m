function plotBoots_MSW(CParameterMC, n, coverageMCMSW, coverageMCBoots, horizons, columnnames, MCdraws, T, confidence, application, p, dataset_name, IRFselect, cumselect)
%  -Plots the MSW and Bootstrap MC coverage.
%  -Syntax:
%       plotBoots_MSW(CParameterMC, n, coverageMCMSW, coverageMCBoots, horizons, columnnames, MCdraws, T, confidence, application, p, dataset_name, IRFselect, cumselect)
%  -Inputs:
...
title_master = strcat('MC Coverage (',num2str(MCdraws),' MC draws, T=',num2str(T),', C. Parameter=',num2str(round(MC.cparameter,2)),')');
...
title_master = strcat('Cumulative MC Coverage (',num2str(MCdraws),' MC draws, T=',num2str(T),', C. Parameter=',num2str(round(MC.cparameter,2)),')');
