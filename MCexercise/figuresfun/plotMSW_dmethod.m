function plotMSW_dmethod(CParameterMC, n, coverageMCMSW, coverageMCdmethod, horizons, columnnames, MCdraws, T, confidence, application, p, dataset_name, IRFselect, cumselect, IRFpluginMC, IRFZ, IRFChol)
%  -Plots the MSW and d-method MC coverage.
%  -Syntax:
%       plotMSW_dmethod(CParameterMC, n, coverageMCMSW, coverageMCdmethod, horizons, columnnames, MCdraws, T, confidence, application, p, dataset_name, IRFselect, cumselect, IRFpluginMC, IRFZ, IRFChol)
%  -Inputs:
%       CParameterMC:      first stage for the Monte Carlo
...
for i = 1:2
    ...
    if i == 1
        ...
        master_title = strcat('MC Coverage',{' ('}, num2str(MCdraws),{' '},'MC draws, T=',num2str(T),', C. Parameter=',num2str(round(MC.cparameter,2)),')');
        ...
        master_title = strcat('Cumulative', {' '},'MC Coverage', {' ('},num2str(MCdraws),{' '},'MC draws, T=',num2str(T),', C. Parameter=',num2str(round(MC.cparameter,2)),')');
...
output_label = strcat(dataset_name,'_p=',num2str(p),'_T=',num2str(T),'_MCCParameter=',num2str(round(MC.cparameter,2)),'.eps');
...
save(strcat('MC_Coverage_',dataset_name,'_p=',num2str(p),'_T=',num2str(T),'_MCFirstStage=',num2str(round(MC.cparameter,2)),'.mat'));
...
for i = 1:length(IRFselect) 
    ...
    title(strcat(columnnames(iplot), {' ('},num2str(MCdraws), {' '}, 'MC draws, T=',num2str(T),', C. Parameter=',num2str(round(MC.cparameter,2)),')'));
...
for i = 1:length(cumselect) 
    ...
    title(strcat('Cumulative', {' '}, columnnames(iplot), {' ('}, num2str(MCdraws), {' '},'MC draws, T=',num2str(T),', C. Parameter=',num2str(round(MC.cparameter,2)),')'));
...
for iplot = 1:n
    ...
    %title(strcat(varNames(iplot),num2str(MCdraws),'MC draws, T=',num2str(InferenceMSWMC.T),', C. Parameter=',num2str(round(MC.cparameter,2)),')')); 

    
end

master_title = strcat('IRF Plug-in Estimators',{' ('},num2str(MCdraws),{' '},'MC draws, T=',num2str(T),', C. Parameter=',num2str(round(MC.cparameter,2)),')');
...
for iplot = 1:n
    ...
    %title(strcat('Cumulative', {' '},varNames(iplot),num2str(MCdraws),'MC draws, T=',num2str(InferenceMSWMC.T),', C. Parameter=',num2str(round(MC.cparameter,2)),')')); 

    
end

master_title = strcat('Cum IRF Plug-in Estimators',{' ('},num2str(MCdraws),{' '},'MC draws, T=',num2str(T),', C. Parameter=',num2str(round(MC.cparameter,2)),')');
