...
%% 8) Drop the first burnout-p observations (burn-out period)
    ...
    clearvars -except MC MCdata MCdraws mcdraw coverageMCMSW coverageMCdmethod burnout IRFMC FirstStageMC auxparamMC confidence NWlags norm dataset_name varNames IRFselect cumselect
    ...
    clearvars -except MC coverageMCMSW coverageMCdmethod MCdraws mcdraw InferenceMSWMC burnout IRFMC FirstStageMC auxparamMC confidence NWlags norm n dataset_name varNames IRFselect cumselect
...
namdir = strcat(date,'_','K','_','p=',num2str(MC.p),num2str(confidence),'_Design1');
